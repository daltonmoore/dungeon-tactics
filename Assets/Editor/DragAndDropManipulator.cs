...
namespace Editor
{
    public class DragAndDropManipulator : PointerManipulator
    {
        ...
        protected override void RegisterCallbacksOnTarget()
        {
            ...
            target.RegisterCallback<PointerCaptureEvent>(PointerCaptureOutHandler);
        }
        ...
        protected override void UnregisterCallbacksFromTarget()
        {
            ...
            target.UnregisterCallback<PointerCaptureEvent>(PointerCaptureOutHandler);
        }
        ...
        // of that slot. Sets the position of target back to its orginal position
        // if there is no overlapping slot.
        private void PointerCaptureOutHandler(PointerCaptureEvent evt)
        {
            if (enabled)
            {
