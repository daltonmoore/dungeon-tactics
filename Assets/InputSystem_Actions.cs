...
public partial class @InputSystem_Actions: IInputActionCollection2, IDisposable
{
    ...
    ""maps"": [
        ...
        {
            ""name"": ""Dalton"",
            ""id"": ""060a2b5a-f88f-4e50-805c-1867914e9cb0"",
            ""actions"": [
                {
                    ""name"": ""Move"",
                    ""type"": ""Value"",
                    ""id"": ""5e657f70-ddee-4e75-9d50-a373a15a907b"",
                    ""expectedControlType"": ""Vector2"",
                    ""processors"": """",
                    ""interactions"": """",
                    ""initialStateCheck"": true
            ...
            ""bindings"": [
                {
                    ""name"": """",
                    ""id"": ""77b8dd5d-1c5b-42bb-b363-23f284141606"",
                    ""path"": ""<Mouse>/delta"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": """",
    ...
    ""controlSchemes"": [
        ...
        // Dalton
        m_Dalton = asset.FindActionMap("Dalton", throwIfNotFound: true);
        m_Dalton_Move = m_Dalton.FindAction("Move", throwIfNotFound: true);
    }
    ...
    ~@InputSystem_Actions()
    {
        ...
        UnityEngine.Debug.Assert(!m_Dalton.enabled, "This will cause a leak and performance issues, InputSystem_Actions.Dalton.Disable() has not been called.");
    }
    ...
    // Dalton
    private readonly InputActionMap m_Dalton;
    private List<IDaltonActions> m_DaltonActionsCallbackInterfaces = new List<IDaltonActions>();
    private readonly InputAction m_Dalton_Move;
    /// <summary>
    /// Provides access to input actions defined in input action map "Dalton".
    /// </summary>
    public struct DaltonActions
    {
        private @InputSystem_Actions m_Wrapper;
        ...
        /// Construct a new instance of the input action map wrapper class.
        /// </summary>
        public DaltonActions(@InputSystem_Actions wrapper) { m_Wrapper = wrapper; }
        /// <summary>
        /// Provides access to the underlying input action "Dalton/Move".
        /// </summary>
        public InputAction @Move => m_Wrapper.m_Dalton_Move;
        /// <summary>
        /// Provides access to the underlying input action map instance.
        /// </summary>
        public InputActionMap Get() { return m_Wrapper.m_Dalton; }
        /// <inheritdoc cref="UnityEngine.InputSystem.InputActionMap.Enable()" />
        public void Enable() { Get().Enable(); }
        /// <inheritdoc cref="UnityEngine.InputSystem.InputActionMap.Disable()" />
        public void Disable() { Get().Disable(); }
        ...
        public bool enabled => Get().enabled;
        /// <summary>
        /// Implicitly converts an <see ref="DaltonActions" /> to an <see ref="InputActionMap" /> instance.
        /// </summary>
        public static implicit operator InputActionMap(DaltonActions set) { return set.Get(); }
        /// <summary>
        /// Adds <see cref="InputAction.started"/>, <see cref="InputAction.performed"/> and <see cref="InputAction.canceled"/> callbacks provided via <param cref="instance" /> on all input actions contained in this map.
        /// </summary>
        /// <param name="instance">Callback instance.</param>
        ...
        /// If <paramref name="instance" /> is <c>null</c> or <paramref name="instance"/> have already been added this method does nothing.
        /// </remarks>
        /// <seealso cref="DaltonActions" />
        public void AddCallbacks(IDaltonActions instance)
        {
            if (instance == null || m_Wrapper.m_DaltonActionsCallbackInterfaces.Contains(instance)) return;
            m_Wrapper.m_DaltonActionsCallbackInterfaces.Add(instance);
            @Move.started += instance.OnMove;
            @Move.performed += instance.OnMove;
            @Move.canceled += instance.OnMove;
        }
        ...
        /// </remarks>
        /// <seealso cref="DaltonActions" />
        private void UnregisterCallbacks(IDaltonActions instance)
        {
            @Move.started -= instance.OnMove;
            @Move.performed -= instance.OnMove;
            @Move.canceled -= instance.OnMove;
        ...
        /// <summary>
        /// Unregisters <param cref="instance" /> and unregisters all input action callbacks via <see cref="DaltonActions.UnregisterCallbacks(IDaltonActions)" />.
        /// </summary>
        /// <seealso cref="DaltonActions.UnregisterCallbacks(IDaltonActions)" />
        public void RemoveCallbacks(IDaltonActions instance)
        {
            if (m_Wrapper.m_DaltonActionsCallbackInterfaces.Remove(instance))
                UnregisterCallbacks(instance);
        }
        ...
        /// If <paramref name="instance" /> is <c>null</c>, calling this method will only unregister all existing callbacks but not register any new callbacks.
        /// </remarks>
        /// <seealso cref="DaltonActions.AddCallbacks(IDaltonActions)" />
        /// <seealso cref="DaltonActions.RemoveCallbacks(IDaltonActions)" />
        /// <seealso cref="DaltonActions.UnregisterCallbacks(IDaltonActions)" />
        public void SetCallbacks(IDaltonActions instance)
        {
            foreach (var item in m_Wrapper.m_DaltonActionsCallbackInterfaces)
                UnregisterCallbacks(item);
            m_Wrapper.m_DaltonActionsCallbackInterfaces.Clear();
            AddCallbacks(instance);
        }
    }
    /// <summary>
    /// Provides a new <see cref="DaltonActions" /> instance referencing this action map.
    /// </summary>
    public DaltonActions @Dalton => new DaltonActions(this);
    ...
    /// <summary>
    /// Interface to implement callback methods for all input action callbacks associated with input actions defined by "Dalton" which allows adding and removing callbacks.
    /// </summary>
    /// <seealso cref="DaltonActions.AddCallbacks(IDaltonActions)" />
    /// <seealso cref="DaltonActions.RemoveCallbacks(IDaltonActions)" />
    public interface IDaltonActions
    {
        /// <summary>
        /// Method invoked when associated input action "Move" is either <see cref="UnityEngine.InputSystem.InputAction.started" />, <see cref="UnityEngine.InputSystem.InputAction.performed" /> or <see cref="UnityEngine.InputSystem.InputAction.canceled" />.
        /// </summary>
